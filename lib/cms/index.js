...
Cms.prototype.getFocusCities = function(sourceId, qs, outputFormat) {
  var ops = this.params(qs);
  var url = this.url('https://reports-allegiantair.stg.allegiantair.com/ibmcognos/cgi-bin/cognos.cgi/rds/promptDescription/report/') + sourceId;
